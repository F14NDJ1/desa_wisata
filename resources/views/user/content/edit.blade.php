<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLongTitle">Form Edit Content</h5>
        ...
        <div class="row">
            <div class="col-md form-group">
                <div class="form-group">
                    <label> Content </label>
                    <textarea class="form-control" id="content" placeholder="Enter the Description" name="content">{{ $data->content }}</textarea>
                </div>
            </div>
        </div>
